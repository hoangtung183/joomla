...
var Skype = new function () {
    ...
    this.SkypeClientDownloadUrl = window.location.protocol + "//www.skype.com/download";
    ...
    this.assetPrefix = window.location.protocol + "//cdn.dev.skype.com/uri/";
    ...
    function setImageAttributes(size, color) {
        ...
        this.focusLinks.linkImageAltTag = "Skype Icon (" + this.assetSize + "px)";
        this.callLinks.linkImageAltTag = "Call Button (" + this.assetSize + "px)" ;
        this.videoLinks.linkImageAltTag = "Call Button (" + this.assetSize + "px)" ;
        this.chatLinks.linkImageAltTag = "Chat Button (" + this.assetSize + "px)" ;
        this.multiChatLinks.linkImageAltTag = "Chat Button (" + this.assetSize + "px)" ;
        this.dropdownLinks.linkImageAltTag = "Dropdown Button (" + this.assetSize + "px)" ;
